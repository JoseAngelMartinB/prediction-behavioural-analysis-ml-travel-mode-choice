...
# -*- coding: utf-8 -*-
"""
Hyperparameter Tunning of the Machine Learning methods for the optima dataset.
...
# Load the data
dataset_prefix = "optima_ext"
#dataset_prefix = "optima"
...
hyperparameters = {"RF" : {"n_estimators": hyperopt.pyll.scope.int(hyperopt.hp.quniform('n_estimators', 1, 200,1)),
                   ...
                   "SVM" : {"kernel": hyperopt.hp.choice('kernel', ['rbf']),
                            ...
                            "nystrom_components": hyperopt.hp.choice('nystrom_components', [int(X_sample.shape[0]*(CV-1)/CV * 0.99)]),
                   ...
                   "NN"  : {"hidden_layer_sizes": hyperopt.pyll.scope.int(hyperopt.hp.quniform('hidden_layer_sizes', 10, 500,1)),
                            "activation" : hyperopt.hp.choice('activation', ["tanh"]),
